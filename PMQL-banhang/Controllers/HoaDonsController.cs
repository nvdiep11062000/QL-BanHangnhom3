...
namespace PMQL_banhang.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        {
            var hoaDons = db.HoaDons.Include(h => h.ChiTietHD).Include(h => h.KhachHang).Include(h => h.NhanVien);
        ...
        {
            ViewBag.MaHD = new SelectList(db.ChiTietHDs, "MaHD", "MaSP");
        ...
        public ActionResult Create([Bind(Include = "MaHD,MaKH,MaNV,NgayLapHD,NgayGiaoHang")] HoaDon hoaDon)
        {
            ...
            ViewBag.MaHD = new SelectList(db.ChiTietHDs, "MaHD", "MaSP", hoaDon.MaHD);
